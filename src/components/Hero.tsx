    ...
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-4 overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative z-10 text-center lg:text-left">
          ...
          >
            Grow your Facebook & Instagram pages with <span className="text-primary italic">smarter content.</span>
          </motion.h1>
          ...
          >
            Zidup helps small businesses create better posts, plan content, prepare campaigns, and understand what actually works — without bots, fake engagement, or marketing stress.
          </motion.p>
          ...
          >
            <span className="font-black text-xs uppercase tracking-tighter">Built for small businesses in Morocco</span>
          </motion.div>
        </div>
