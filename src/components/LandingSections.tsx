...
export function FAQSection() {
  ...
  const faqs = [
    { q: "Is Zidup 100% legal?", a: "Yes. Zidup uses official APIs and follows all professional social media policies. We never use bots or fake engagement." },
    { q: "Can I use it for multiple businesses?", a: "Our Pro and Agency plans support multiple business pages. You can switch between them easily from the dashboard." },
    { q: "Do I need marketing experience?", a: "No! Zidup is designed for beginners. Our AI guides you through every step of content and ad creation." },
    { q: "Is there a free version?", a: "Yes, you can use our Free plan forever with limited AI generations and features." },
  ]
